export const fr = {
  ...
  dash_friend_req_success: "Infos",
  FRIEND_REQUEST_ALREADY_SENT: "Demande d'ami déjà envoyée.",
  FRIEND_ACCEPTED_MUTUAL: "Vous êtes maintenant amis ! Demande mutuelle détectée.",
  friend_accepted_standard: "a accepté votre demande d'ami !",
  friend_rejected_standard: "a refusé votre demande d'ami.",
  ...
  dash_invite_rejected: "a refusé votre invitation au jeu.",
  dash_game_starting: "🚀 LE JEU COMMENCE !",
  dash_game_starting_desc: "Adversaire :",
  dash_mutual_invite_title: "⚔️ INVITATION MUTUELLE !",
  dash_mutual_invite_desc: "vous a également invité ! Acceptez pour commencer le match immédiatement.",
  ...
  game_online_forfeit_desc: "L'adversaire a quitté le jeu.",
  ...
  prof_2fa_disable_btn: "Désactiver la 2FA",
  prof_2fa_disable_confirm: "Êtes-vous sûr de vouloir désactiver la 2FA ?",
  prof_2fa_disabled_msg: "La 2FA a été désactivée.",
